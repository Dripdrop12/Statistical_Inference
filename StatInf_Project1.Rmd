...
The standard deviation of the simulated data is `r round(sim.sd,3)`, while the theoretical standard deviation is `r round(theoretical.sd,3)`. The respective variances are `r round(sim.var,3)` and `r round(theoretical.var,3)`.  These differences are slightly larger than the differences between the sample means and theoretical mean, but they are still very similar.
